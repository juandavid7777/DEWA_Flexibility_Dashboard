...
st.markdown("""---""")
st.markdown('<b style="color:midnightblue ; font-size: 20px">Ambient and model conditions</b>', unsafe_allow_html=True)
...
st.markdown("""---""")
st.markdown('<b style="color:midnightblue ; font-size: 20px">HVAC efficiency</b>', unsafe_allow_html=True)
st.plotly_chart(fig_CvsE, use_container_width=True)

st.markdown("""---""")
st.markdown('<b style="color:midnightblue ; font-size: 20px">Model results</b>', unsafe_allow_html=True)
